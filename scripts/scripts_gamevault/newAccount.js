...
async function loginAndSaveState() {
  ...
  try {
    ...
    try {
      ...
      console.log('Login successful! Now proceeding to create new account...');
...
async function createNewAccount(page, browser) {
    // Assuming login function has been run
    ...
    try {
        ...
        await page.fill('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[2]/form/div/div/div[2]/input', newAccountName);
        console.log(`Searching for account: ${newAccountName}`);
        ...
        if (await firstAccountElement.count() > 0) {
            ...
            if (accountText && accountText.trim() === newAccountName) {
            accountFound = true;
            }
        }
        ...
        // Only create new account if not found
        if (!accountFound) {
            // Click on New Account button
            await page.click('button.el-button--primary:has-text("New Account")');
            console.log('New Account button clicked');
            
            // Wait for the form to load
            await page.waitForTimeout(2000);

            // Click on the input field using XPath
            await page.click('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[2]/form/div/div/div/input');
            
            // Type the new account name
            await page.fill('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[2]/form/div/div/div/input', newAccountName);
            console.log(`New account name typed: ${newAccountName}`);
            
            // Click on the password input field
            await page.click('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[2]/form/div[4]/div/div/input');
            
            // Type the new password
            await page.fill('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[2]/form/div[4]/div/div/input', newPassword);
            console.log(`New password typed: ${newPassword}`);
            
            // Click on the confirm password input field
            await page.click('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[2]/form/div[5]/div/div/input');
            
            // Type the new password again for confirmation
            await page.fill('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[2]/form/div[5]/div/div/input', newPassword);
            console.log(`Confirm password typed: ${newPassword}`);
            
            // Click on the Save button
            await page.click('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div[6]/div/div[3]/button[2]');
            console.log('Save button clicked');
            
            // Check for error message indicating account name already used
            try {
                // Wait up to 3 seconds for the alert to appear
                const errorMessage = await page.waitForSelector('[role="alert"] .el-message__content', {
                timeout: 3000
                });
