...
async function redeem(page, browser) {
    ...
    try {
        ...
        if (accountFound) {
            ...
            await page.click('xpath=//*[@id="app"]/div/div[4]/div[2]/div[2]/section/div/div/div[2]/div/button/span');
            
            // Wait for redeem form to appear
            await page.waitForTimeout(1000);
        ...
        console.error('Error during redeeming amount:', error);
    }
