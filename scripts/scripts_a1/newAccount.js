...
const username = process.argv[2] || 'TestAllNOne';
...
async function loginAndSaveState() {
  ...
  try {
    ...
    await page.goto('https://agentserver.mrallinone777.com/');
...
async function createNewAccount(page, browser) {
    ...
    await page.locator('iframe').nth(1).contentFrame().locator('iframe[name="layui-layer-iframe1"]').contentFrame().getByRole('textbox', { name: 'Please enter Username' }).fill(newAccountName);
    await page.locator('iframe').nth(1).contentFrame().locator('iframe[name="layui-layer-iframe1"]').contentFrame().getByRole('textbox', { name: 'Please enter Recharge Balance' }).fill("0");
    await page.locator('iframe').nth(1).contentFrame().locator('iframe[name="layui-layer-iframe1"]').contentFrame().getByRole('textbox', { name: 'Please enter Login password' }).fill(newPassword);
    await page.locator('iframe').nth(1).contentFrame().locator('iframe[name="layui-layer-iframe1"]').contentFrame().getByRole('textbox', { name: 'Please enter Confirm password' }).fill(newPassword);
    await page.locator('iframe').nth(1).contentFrame().locator('iframe[name="layui-layer-iframe1"]').contentFrame().getByRole('button', { name: 'Submit' }).click();

    // Display what the pop up says
