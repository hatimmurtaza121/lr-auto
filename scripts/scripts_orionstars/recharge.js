...
async function recharge(page, browser) {
    ...
    try {
        ...
        await page.locator('iframe[name="frm_main_content"]').contentFrame().getByRole('textbox', { name: 'ID or Account' }).fill(accountName);
        ...
        await firstRow.locator('a', { hasText: 'Update' }).click();
        ...
        await page.locator('#Container iframe').contentFrame().locator('#txtReason').fill(remarks);
